...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        try {
            if (isset($data_assoc['entrada'])) {
                $carne = createCarne($data_assoc['valor_total'], $data_assoc['qtd_parcelas'], $data_assoc['data-primeiro-vencimento'], $data_assoc['periodicidade'], $data_assoc['entrada']);
            } else {
